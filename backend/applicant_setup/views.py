...
def applicant_profile_setup_step1(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if saved_profile.setup_step_progress < 2:
                ...
                saved_profile.save()
            return redirect('applicant_setup:applicant_setup_step2')
    else:
    ...
    return render(request, 'applicant_setup/applicant_profile_step1.html', context)
...
def applicant_profile_setup_step2(request):
    ...
    if profile.setup_step_progress < 2:
        return redirect('applicant_setup:applicant_setup_step1')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if saved_profile.setup_step_progress < 3:
                ...
                saved_profile.save()
            return redirect('applicant_setup:applicant_setup_step3')
    else:
    ...
    return render(request, 'applicant_setup/applicant_profile_step2.html', context)
...
def applicant_profile_setup_step3(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('applicant_setup:applicant_setup_complete')
    else:
    ...
    return render(request, 'applicant_setup/applicant_profile_step3.html', context)
...
def applicant_profile_setup_complete(request):
    ...
    return render(request, 'applicant_setup/applicant_profile_completion.html',context)